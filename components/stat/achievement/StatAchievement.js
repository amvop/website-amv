    ...
    <section className="p-6 bg-gray-800 text-gray-100">
      <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
        <div className="flex flex-col justify-start m-2 lg:m-6">
          ...
          <p className="text-sm sm:text-base">Champions</p>
        </div>
        <div className="flex flex-col justify-start m-2 lg:m-6">
        ...
        <div className="flex flex-col justify-start m-2 lg:m-6">
          ...
          <p className="text-sm sm:text-base">Alumnus</p>
        </div>
        <div className="flex flex-col justify-start m-2 lg:m-6">
          <p className="text-4xl font-bold leading-none lg:text-6xl">10+</p>
        ...
        <div className="flex flex-col justify-start m-2 lg:m-6">
          <p className="text-4xl font-bold leading-none lg:text-6xl">25</p>
...
export default StatAchievement;
